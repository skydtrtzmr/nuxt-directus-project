      ...
      <div class="dashboard-section">
        ...
        <div v-if="exams.length > 0" class="exam-cards">
          <div v-for="exam in exams" :key="exam.id" class="exam-card">
            ...
            <div class="exam-info">
              <div class="exam-time">时长: {{ exam.duration }}分钟</div>
              <div class="exam-due">截止时间: {{ formatDate(exam.dueDate) }}</div>
            </div>
            <div class="progress-bar">
              <div class="progress" :style="{ width: `${exam.progress}%` }"></div>
            </div>
            <div class="exam-progress-text">完成度: {{ exam.progress }}%</div>
        ...
        <div v-for="recommendation in recommendations" :key="recommendation.id" class="recommendation-card">
          ...
          <div class="recommendation-content">
            ...
            <div class="recommendation-meta">
              ...
              <span class="recommendation-duration">{{ recommendation.duration }}</span>
            </div>
            <router-link :to="recommendation.link" class="btn btn-secondary">查看详情</router-link>
          </div>
        </div>
      </div>
    </div>
