...
# 配置完成后，运行以下命令进行构建镜像：
# docker build -t skydtrtzmr/my-directus-client:1.3.6 ./

# 指定最新版本：
# docker tag skydtrtzmr/my-directus-client:1.3.6 skydtrtzmr/my-directus-client:latest
# （注意替换为自己的镜像版本）
...
# 设置 Node.js 运行环境为开发模式（因为这里不是最终runtime）
ENV NODE_ENV=development
# 【注意】如果这里设置成production，会导致devdependencies被忽略，从而引起错误。
