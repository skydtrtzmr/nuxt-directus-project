        ...
        >
            ...
            <div class="flex flex-col gap-3">
                ...
                <div 
                    ...
                    :class="{'option-selected': userAnswers.includes('A')}"
                >
                    <Checkbox
                        v-model="userAnswers"
                ...
                <div 
                    ...
                    :class="{'option-selected': userAnswers.includes('B')}"
                >
                    <Checkbox
                        v-model="userAnswers"
                ...
                <div 
                    ...
                    :class="{'option-selected': userAnswers.includes('C')}"
                >
                    <Checkbox
                        v-model="userAnswers"
                ...
                <div 
                    ...
                    :class="{'option-selected': userAnswers.includes('D')}"
                >
                    <Checkbox
                        v-model="userAnswers"
